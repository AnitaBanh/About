...
const Work = () => {
  return (
    <div name="work" className="w-full h-screen text-slate-100 bg-slate-900">
...
{/* image hover */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              React | Mongo DB | GraphQL | Node.js
              </span>
...
{/* image hover */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <br/>
              <span className="text-lg text-white tracking-wider">
              Handlebars | SQL | bcrypt | Express.js | Node.js
              </span>
              <div className="pt-8 text-center">
...
{/* image hover */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://expressjs-notetaker.herokuapp.com/" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/AnitaBanh/Expressjs-Note-Taker" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">Code</button>
                </a>
              </div>
            </div>
...
{/* image hover */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://drive.google.com/file/d/1m2O6ZCEMxdtUvSLwlOZgmlQddCo_-Fpc/view" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/AnitaBanh/Social-Network-API" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">Code</button>
                </a>
              </div>
            </div>
...
{/* image hover */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://anitabanh.github.io/JavaScript-Password-Generator/" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/AnitaBanh/JavaScript-Password-Generator" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">Code</button>
                </a>
              </div>
            </div>
...
{/* image hover */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://anitabanh.github.io/JavaScript-Timed-Quiz/" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/AnitaBanh/JavaScript-Timed-Quiz" target="_blank">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-slate-700 font-bold text-lg">Code</button>
                </a>
              </div>
            </div>
